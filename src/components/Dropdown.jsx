  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <button
        ...
        className="flex w-full justify-center gap-x-1.5 rounded cursor-pointer px-3 py-2 font-semibold text-gray-900 bg-gray-300 shadow-xs hover:bg-gray-50"
      >
        Exercises
      ...
      {isOpen && (
        <div className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black/5 transition-opacity">
          ...
          <h1
            ...
            ><Link to='/' className="block px-4 py-2 hover:bg-gray-100 hover:text-gray-60"  onClick={() => setIsOpen(false)}>
              Home
            </Link></h1>
              <h1
